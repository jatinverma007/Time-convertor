...
$query1=" select*from `time` where `country`='{$_GET['countryToConvert']}'";
$result1=$connection->query($query1);
$timeZoneToConvert=$result1->fetch_row();
//var_dump($timeZoneToConvert);

//Extracting TimeZone of Country Entered
$query1=" select*from `time` where `country`='{$_GET['countryEntered']}'";
$result1=$connection->query($query1);
...
<!DOCTYPE html>
    <html>
<body background="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvnzauTGKJMGMvxL3KaAnhonzNF3qnh9MZbO-CefdKScpocsGH">
